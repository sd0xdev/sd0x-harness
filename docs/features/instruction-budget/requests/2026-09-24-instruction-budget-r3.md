...
| Acceptance | Done   | Codex review ✅ Ready (repo-copy execution, template left out of the share, depth-first import skip — all fixed); `--verify-ac` 2026-09-25: 4/4 Complete at High |
...
| Acceptance | Done   | Codex thorough review ✅ Ready (round 2), AC Coverage 5/5; `--verify-ac` not yet run, hence Candidate Complete. Carried to R2: install `protected-branches.sh` with the override scaffold, or every branch reads as unknown |

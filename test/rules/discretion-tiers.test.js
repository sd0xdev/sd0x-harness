...
// R7: pins the closed sets in rules/discretion.md — the anchor register, the 14-file baseline
...
const CANONICAL_AUTHORIZATION_BLOCK = [
  ...
  // The goal-mode credential (2026-09-24, maintainer decision, git-autonomy R7) widens WHO may
  // skip the per-use question, not WHAT is granted: the command spans stay `git add` + `git commit`.

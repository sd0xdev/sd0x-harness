...
One command auto-detects framework, package manager, database, entrypoints, and scripts. Installs a subset of rules and hooks; the full plugin bundles 18 rules + 7 hooks. Use `--lite` to only configure CLAUDE.md (skip rules/hooks).
